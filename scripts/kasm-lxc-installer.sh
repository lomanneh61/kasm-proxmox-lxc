...
# ---------------------------------------------------------
#  FIX 1: Persistent DHCP Networking for Debian 12 LXC
# ---------------------------------------------------------
msg_info "Configuring persistent DHCP networking inside container"

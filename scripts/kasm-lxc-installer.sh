...
# Allow DHCP client (UDP 68) and DHCP server (UDP 67)
pve-firewall rule add --vmid "$CTID" --action accept --proto udp --dport 67 
pve-firewall rule add --vmid "$CTID" --action accept --proto udp --dport 68

# Allow DNS (UDP/TCP 53)
pve-firewall rule add --vmid "$CTID" --action accept --proto udp --dport 53 
pve-firewall rule add --vmid "$CTID" --action accept --proto tcp --dport 53
